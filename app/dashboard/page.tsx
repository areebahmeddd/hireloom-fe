...
import { Plus, Users, Calendar, FileText, TrendingUp, Clock, CheckCircle, Send } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-slate-900">Active Job Postings</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-900">Interview scheduled with Alice Johnson</p>
                  <p className="text-xs text-slate-500">Frontend Developer • 2 minutes ago</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <TrendingUp className="w-5 h-5 text-blue-500" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-900">15 new resumes analyzed for Backend Developer</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-900">Initial contact sent to 8 candidates</p>
                  <p className="text-xs text-slate-500">Product Designer • 1 hour ago</p>
                </div>
              </div>
            </div>
          </CardContent>
