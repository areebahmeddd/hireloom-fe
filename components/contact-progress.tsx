          ...
          {selectedActivity && (
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold">{selectedActivity.candidate}</h3>
                  <p className="text-sm text-slate-600">{job.title} Candidate</p>
                </div>
              </div>
              ...
              <div className="border rounded-lg p-4 space-y-3">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-sm text-slate-600">{selectedActivity.action}</p>
                  </div>
                  
                  <div>
                    <span className="text-sm font-medium text-slate-700">Time:</span>
                    <p className="text-sm text-slate-600">{selectedActivity.timestamp}</p>
                  </div>
                  
                  <div>
                    <span className="text-sm font-medium text-slate-700">Status:</span>
                    <p className="text-sm text-slate-600">{selectedActivity.status}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{selectedActivity.status === 'Responded' ? '✓ Yes' : '✗ No'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-600">Links clicked:</span>
                    <span>{selectedActivity.status === 'Responded' ? '2' : '0'}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-2 pt-4">
                ...
                <Button variant="ghost" size="sm">Mark as No Response</Button>
              </div>
            </div>
          )}
        </DialogContent>
