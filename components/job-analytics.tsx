      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-slate-700">Initial Contact</span>
              <span className="text-sm font-bold text-slate-900">{job.contacted}</span>
            </div>
            <div className="w-full bg-slate-200 rounded-full h-2">
              <div 
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-bold text-slate-900">{job.scheduled}</span>
            </div>
            <div className="w-full bg-slate-200 rounded-full h-2">
              <div 
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {['React', 'TypeScript', 'Next.js', 'JavaScript', 'CSS'].map((skill, index) => (
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-900">Initial outreach started</p>
